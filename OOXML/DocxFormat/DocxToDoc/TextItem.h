...
#include "../../../MsBinaryFile/Common/Base/Aggregat.h"
...
namespace Docx2Doc
{
	...
	public:
		...
		template<class T> std::vector<ParagraphItem> GetAllRunItemsByType() const
		{
		...
		template<class T> std::vector<ParagraphItem> GetAllParagraphItemsByType() const
		{
			std::vector<ParagraphItem> allParagraphItems;
