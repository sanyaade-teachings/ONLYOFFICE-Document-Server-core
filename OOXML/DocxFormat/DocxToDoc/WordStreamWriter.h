...
namespace STREAMS
{
	...
	public:
		...
		inline HRESULT Init (/*IStorage*/void*	pStorage, ULONG nBPos)
		{
		...
		//
		inline int Push (const void* pBuffer, ULONG nBufSize)
		{
		...
		inline int Push (const void* pBuffer, ULONG nBufSize, int nOffSet)
		{
			/*if ( (m_pBin != NULL) && (pBuffer != NULL) )
			{
				LARGE_INTEGER oStatus;
		...
		inline CFCPP::IStream* Get ()
		{
			return m_pBin;
		}

		operator CFCPP::IStream* ()
		{
			return (CFCPP::IStream*)m_pBin;
		}
