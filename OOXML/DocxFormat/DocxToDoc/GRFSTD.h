...
namespace Docx2Doc
{
	...
	public:
		GRFSTD() : GRFSTDUnsignedShort(0)
		{
		}

		explicit GRFSTD( unsigned short _grfstd ) : GRFSTDUnsignedShort(_grfstd)
		{
		}

		explicit GRFSTD( bool _fAutoRedef, bool _fHidden, bool _fPersonalCompose, bool _fPersonalReply, bool _fPersonal,
						 bool _fSemiHidden, bool _fLocked, bool _fUnhideWhenUsed, bool _fQFormat ) : GRFSTDUnsignedShort(0)
		{
