...
namespace Docx2Doc
{
	...
	unsigned int LineStyleBooleans::Get() const
	{
		...
		return DocFileFormat::FormatUtils::BytesToInt32 (oBits.GetBytes(), 0, sizeof(unsigned int));
	}
	...
	unsigned int GeometryBooleans::Get() const
	{
		...
		return DocFileFormat::FormatUtils::BytesToInt32 (oBits.GetBytes(), 0, sizeof(int));
	}
	...
	unsigned int GroupShapeBooleans::Get() const
	{
		...
		return DocFileFormat::FormatUtils::BytesToUInt32 (oBits.GetBytes(), 0, sizeof(unsigned int));
	}
