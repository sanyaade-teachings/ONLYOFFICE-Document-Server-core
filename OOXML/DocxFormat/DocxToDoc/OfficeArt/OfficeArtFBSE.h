...
namespace OfficeArt
{
	...
	public:
		...
		OfficeArtFBSE (int bEmBlip, Enumerations::MSOBLIPTYPE _btWin32,
			Enumerations::MSOBLIPTYPE _btMacOS,
			unsigned int _size,
			const std::vector<BYTE>& _rgbUid = std::vector<BYTE>( 0, 16 ),
